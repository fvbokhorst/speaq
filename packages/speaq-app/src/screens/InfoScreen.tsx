...
const INFO: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  ...
  fr: {
    ...
    sections: [
      ...
      { heading: "Q-Credits et Portefeuille", body: "Les Q-Credits sont la monnaie interne de SPEAQ. 1 QC = 1 USD. Les transactions sont instantanees et gratuites entre utilisateurs. Votre solde est stocke localement." },
  ...
  es: {
    ...
    sections: [
      ...
      { heading: "Q-Credits y Cartera", body: "Los Q-Credits son la moneda interna de SPEAQ. 1 QC = 1 USD. Las transacciones son instantaneas y gratuitas. Tu saldo se almacena localmente." },
  ...
  ru: {
    ...
    sections: [
      ...
      { heading: "Q-Credits i Koshelek", body: "Q-Credits - vnutrennyaya valyuta SPEAQ. 1 QC = 1 USD. Tranzaktsii mgnovennyye i besplatnyye. Balans khranitsya lokalno." },
  ...
  de: {
    ...
    sections: [
      ...
      { heading: "Q-Credits und Geldborse", body: "Q-Credits sind SPEAQs interne Wahrung. 1 QC = 1 USD. Transaktionen sind sofort und kostenlos. Ihr Guthaben wird lokal gespeichert." },
  ...
  sl: {
    ...
    sections: [
      ...
      { heading: "Q-Credits in Denarnica", body: "Q-Credits so notranja valuta SPEAQ. 1 QC = 1 USD. Transakcije so takojsnje in brezplacne. Stanje je shranjeno lokalno." },
  ...
  lg: {
    ...
    sections: [
      ...
      { heading: "Q-Credits n'Ensawo", body: "Q-Credits ze ssente za SPEAQ. 1 QC = 1 USD. Entambuza za mangu era za bwereere. Ensawo yo etereddwa ku simu yo." },
  ...
  sw: {
    ...
    sections: [
      ...
      { heading: "Q-Credits na Mkoba", body: "Q-Credits ni sarafu ya ndani ya SPEAQ. 1 QC = 1 USD. Shughuli ni za papo hapo na bila malipo. Salio linahifadhiwa ndani ya kifaa." },
