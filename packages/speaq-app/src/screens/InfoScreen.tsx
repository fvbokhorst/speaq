...
const INFO: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  en: {
    ...
    sections: [
      ...
      { heading: "Your SPEAQ ID", body: "Your SPEAQ ID is generated locally on your device using secure random numbers. It is not linked to your phone number, email, or real name. No one can trace your SPEAQ ID back to you unless you choose to share it." },
      ...
      { heading: "Proof of Contribution (C+) - Early Contributions", body: "Before the network fully launches, all contributions are tracked locally on your device. Every contribution reward is double-signed:\n\n1. You sign with your private key (proves your identity)\n2. The relay server co-signs as witness (proves the work actually happened)\n\nBoth signatures are stored in your contribution ledger. When the network fully launches, only entries with BOTH signatures are accepted. This makes fraud impossible - you cannot fake the relay's signature, and the relay only signs when you actually contribute to the network.\n\nYour contribution ledger is your proof of early contribution. The earlier you start, the more you earn before the first halving." },
      { heading: "Secure Wallet", body: "SPEAQ generates secure signing keys on your device when you first open the wallet. This keypair is your verified network identity. Your private key never leaves your device - not even SPEAQ can access it. When you send Q-Credits, the transaction is signed with your personal encrypted key and verified by the network. No intermediary, no central authority, no backdoor. Your keys, your money." },
      { heading: "SPEAQ Network", body: "SPEAQ has its own secure network. Blocks are produced every 30 seconds by validators selected through Proof of Contribution. Each block is verified and encrypted for maximum security. The network tracks Q-Credit balances, processes transactions, and ensures no one can create money from nothing. Maximum supply: 21,000,000 QC, enforced by code, not by policy." },
    ],
  },
  nl: {
    ...
    sections: [
      ...
      { heading: "Je SPEAQ ID", body: "Je SPEAQ ID wordt lokaal op je apparaat gegenereerd met veilige willekeurige getallen. Het is niet gekoppeld aan je telefoonnummer, e-mail of echte naam. Niemand kan je SPEAQ ID naar jou herleiden tenzij je het zelf deelt." },
      ...
      { heading: "Proof of Contribution (C+) - Vroege Bijdragen", body: "Voordat het netwerk volledig live gaat, worden alle bijdragen lokaal bijgehouden op je apparaat. Elke bijdrage beloning wordt dubbel gesigned:\n\n1. Jij signeert met je private key (bewijst je identiteit)\n2. De relay server tekent mee als getuige (bewijst dat het werk echt is gedaan)\n\nBeide handtekeningen worden opgeslagen in je bijdrage ledger. Bij netwerk launch worden alleen entries met BEIDE handtekeningen geaccepteerd. Fraude is onmogelijk.\n\nJe bijdrage ledger is je bewijs van vroege bijdrage. Hoe eerder je begint, hoe meer je verdient voor de eerste halving." },
      { heading: "Beveiligde Portemonnee", body: "SPEAQ genereert veilige signing keys op je apparaat wanneer je de portemonnee voor het eerst opent. Dit keypair is je geverifieerde netwerkidentiteit. Je private key verlaat nooit je apparaat - zelfs SPEAQ kan er niet bij. Wanneer je Q-Credits verstuurt, wordt de transactie gesigned met je persoonlijke versleutelde sleutel en geverifieerd door het netwerk. Geen tussenpersoon, geen centrale autoriteit, geen achterdeur. Jouw sleutels, jouw geld." },
      { heading: "SPEAQ Netwerk", body: "SPEAQ heeft zijn eigen beveiligd netwerk. Blocks worden elke 30 seconden geproduceerd door validators geselecteerd via Proof of Contribution. Elk block wordt geverifieerd en versleuteld voor maximale beveiliging. Het netwerk houdt Q-Credit saldi bij, verwerkt transacties, en zorgt dat niemand geld uit het niets kan maken. Maximale voorraad: 21.000.000 QC, afgedwongen door code, niet door beleid." },
    ],
  },
  fr: {
    ...
    sections: [
      ...
      { heading: "Preuve de Contribution (C+) - Contributions Anticipees", body: "Avant le lancement complet du reseau, toutes les contributions sont suivies localement. Chaque recompense est doublement signee. La fraude est impossible car les deux signatures sont necessaires." },
      { heading: "Portefeuille Securise", body: "SPEAQ genere des cles de signature securisees sur votre appareil. Cette paire de cles est votre identite verifiee sur le reseau. Votre cle privee ne quitte jamais votre appareil. Vos cles, votre argent." },
      { heading: "Reseau SPEAQ", body: "SPEAQ possede son propre reseau securise. Les blocs sont produits toutes les 30 secondes. Chaque bloc est verifie et chiffre pour une securite maximale. Offre maximale: 21.000.000 QC." },
    ],
  },
  es: {
    ...
    sections: [
      ...
      { heading: "Prueba de Contribucion (C+) - Contribuciones Tempranas", body: "Antes del lanzamiento completo de la red, todas las contribuciones se rastrean localmente. Cada recompensa se firma dos veces. El fraude es imposible ya que ambas firmas son necesarias." },
      { heading: "Billetera Segura", body: "SPEAQ genera claves de firma seguras en tu dispositivo. Este par de claves es tu identidad verificada en la red. Tu clave privada nunca sale de tu dispositivo. Tus claves, tu dinero." },
      { heading: "Red SPEAQ", body: "SPEAQ tiene su propia red segura. Los bloques se producen cada 30 segundos. Cada bloque es verificado y cifrado para maxima seguridad. Suministro maximo: 21.000.000 QC." },
    ],
  },
  ru: {
    ...
    sections: [
      ...
      { heading: "Dokazatelstvo Vklada (C+) - Rannie Vklady", body: "Do polnogo zapuska seti vse vklady otslezhivayutsya lokalno. Kazhdaya nagrada podpisyvaetsya dvazhdy. Moshennichestvo nevozmozhno." },
      { heading: "Bezopasniy Koshelek", body: "SPEAQ generiruet bezopasnye klyuchi dlya podpisi na vashem ustroystve. Eta para klyuchey - vasha proverennaya setevaya identichnost. Vash privatniy klyuch nikogda ne pokidaet vashe ustroystvo. Vashi klyuchi, vashi dengi." },
      { heading: "Set SPEAQ", body: "SPEAQ imeet sobstvennuyu bezopasnuyu set. Bloki sozdayutsya kazhdye 30 sekund. Kazhdiy blok proveryayetsya i shifruyetsya dlya maksimalnoy bezopasnosti. Maksimalnoe predlozhenie: 21.000.000 QC." },
    ],
  },
  de: {
    ...
    sections: [
      ...
      { heading: "Beweis des Beitrags (C+) - Fruehe Beitrage", body: "Vor dem vollstandigen Start des Netzwerks werden alle Beitrage lokal verfolgt. Jede Belohnung wird doppelt signiert. Betrug ist unmoglich." },
      { heading: "Sichere Wallet", body: "SPEAQ generiert sichere Signaturschlussel auf Ihrem Gerat. Dieses Schlusselpaar ist Ihre verifizierte Netzwerk-Identitat. Ihr privater Schlussel verlasst niemals Ihr Gerat. Ihre Schlussel, Ihr Geld." },
      { heading: "SPEAQ Netzwerk", body: "SPEAQ hat sein eigenes sicheres Netzwerk. Blocke werden alle 30 Sekunden produziert. Jeder Block wird verifiziert und verschlusselt fur maximale Sicherheit. Maximales Angebot: 21.000.000 QC." },
    ],
  },
  sl: {
    ...
    sections: [
      ...
      { heading: "Dokaz prispevka (C+) - Zgodnji prispevki", body: "Pred polnim zagonom omrezja se vsi prispevki sledijo lokalno. Vsaka nagrada je dvojno podpisana. Goljufija je nemogoca." },
      { heading: "Varna Denarnica", body: "SPEAQ generira varne podpisne kljuce na vasi napravi. Ta par kljucev je vasa preverjena omrezna identiteta. Vas zasebni kljuc nikoli ne zapusti naprave. Vasi kljuci, vas denar." },
      { heading: "SPEAQ Omrezje", body: "SPEAQ ima lastno varno omrezje. Bloki se proizvedejo vsakih 30 sekund. Vsak blok je preverjen in sifriran za maksimalno varnost. Najvecja zaloga: 21.000.000 QC." },
    ],
  },
  lg: {
    ...
    sections: [
      ...
      { heading: "Obujulizi bw'Okugaba (C+) - Ensobi ez'Olubereberye", body: "Nga network tennatandika ddala, okusimba kwonna kukola mu kifo kyo. Buli mpeera esainibwa emirundi ebiri. Obbubbi tekisoboka." },
      { heading: "Ensawo Enkuumiddwa", body: "SPEAQ ekola bisumuluzo by'okusayina ebikuumiddwa ku kifaananyi kyo. Bisumuluzo bino bye butamanyiddwa bwo ku network. Ekimu kyo eky'ekyama tekiva ku kifaananyi kyo. Bisumuluzo byo, ssente zo." },
      { heading: "SPEAQ Network", body: "SPEAQ erina network yaayo enkuumiddwa. Blocks zitondebwa buli sekondi 30. Buli block ekakasibwa era ekuumibwa okusingira ddala. Omuwendo ogusingayo: 21.000.000 QC." },
    ],
  },
  sw: {
    ...
    sections: [
      ...
      { heading: "Uthibitisho wa Mchango (C+) - Michango ya Mapema", body: "Kabla ya mtandao kuanzishwa kikamilifu, michango yote inafuatiliwa ndani ya kifaa chako. Kila tuzo inasainiwa mara mbili. Udanganyifu hauwezekani." },
      { heading: "Mkoba Salama", body: "SPEAQ inatengeneza funguo salama za kusaini kwenye kifaa chako. Jozi hii ya funguo ni utambulisho wako uliothitibshwa kwenye mtandao. Funguo yako ya faragha haitoki kwenye kifaa chako kamwe. Funguo zako, pesa zako." },
      { heading: "Mtandao wa SPEAQ", body: "SPEAQ ina mtandao wake salama. Blocks zinazalishwa kila sekunde 30. Kila block inathibitishwa na kusimbwa kwa usalama wa hali ya juu. Ugavi wa juu: 21.000.000 QC." },
    ],
  },
};
