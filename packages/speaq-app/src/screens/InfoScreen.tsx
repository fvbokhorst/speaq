...
const INFO: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  en: {
    ...
    sections: [
      ...
      { heading: "Q-Credits & Wallet", body: "Q-Credits are SPEAQ's internal currency pegged to gold: 1 QC = 0.01 gram of gold. This means the value of your QC is tied to real, physical gold, not to any government currency that can be printed or inflated. Maximum supply is 21,000,000 QC (like Bitcoin, fixed forever). Total gold equivalent: 210 kg. Transactions are instant and free between users. Your wallet shows your balance in grams of gold. You can send QC via SPEAQ ID, QR code, or from your contacts. Projects let you allocate QC for specific purposes." },
      { heading: "Mining", body: "SPEAQ Mining is Proof of Contribution. You earn Q-Credits by helping the network grow. Your phone can relay messages (0.01 QC each), validate transactions (0.02 QC each), store encrypted fragments (0.01 QC each), and more. You earn 2-5 QC per day (0.02-0.05 gram gold). In many countries this is significant income.\n\nHow halving works: every 2,100,000 QC mined by the network, rewards are cut in half. This creates scarcity and protects value. Early miners earn more. The system supports approximately 960 miners initially, decreasing with each halving. Total mining timeline: 40+ years before all 21 million QC are mined.\n\n7 ways to mine:\n1. Relay Mining: relay encrypted messages\n2. Mesh Mining: act as Bluetooth/WiFi node\n3. Bridge Mining: be a cash-to-QC agent\n4. Validation Mining: validate transaction proofs\n5. Storage Mining: store encrypted data\n6. Translation Mining: translate the app\n7. Onboarding Mining: bring new active users" },
  ...
  nl: {
    ...
    sections: [
      ...
      { heading: "Q-Credits & Portemonnee", body: "Q-Credits zijn SPEAQ's interne valuta gekoppeld aan goud: 1 QC = 0,01 gram goud. De waarde van je QC is gekoppeld aan echt, fysiek goud, niet aan een overheidsvaluta die bijgedrukt kan worden. Maximale voorraad: 21.000.000 QC (zoals Bitcoin, voor altijd vast). Totale goudwaarde: 210 kg. Transacties zijn direct en gratis. Je portemonnee toont je saldo in gram goud." },
      { heading: "Mining", body: "SPEAQ Mining is Bewijs van Bijdrage. Je verdient Q-Credits door het netwerk te helpen. Je telefoon kan berichten doorsturen (0,01 QC), transacties valideren (0,02 QC), en versleutelde fragmenten opslaan (0,01 QC). Je verdient 2-5 QC per dag (0,02-0,05 gram goud).\n\nHoe halving werkt: elke 2.100.000 QC gemined door het netwerk worden beloningen gehalveerd. Dit creert schaarste en beschermt de waarde. Vroege miners verdienen meer. Het systeem ondersteunt initieel circa 960 miners, afnemend bij elke halving. Totale mining tijdlijn: 40+ jaar.\n\n7 manieren om te minen:\n1. Relay Mining: berichten doorsturen\n2. Mesh Mining: Bluetooth/WiFi node\n3. Bridge Mining: cash-naar-QC agent\n4. Validatie Mining: transactiebewijzen valideren\n5. Opslag Mining: versleutelde data opslaan\n6. Vertaal Mining: app vertalen\n7. Onboarding Mining: nieuwe gebruikers aanbrengen" },
  ...
  fr: {
    ...
    sections: [
      ...
      { heading: "Q-Credits et Portefeuille", body: "Les Q-Credits sont la monnaie interne de SPEAQ. 1 QC = 0.01 gram gold. Les transactions sont instantanees et gratuites entre utilisateurs. Votre solde est stocke localement." },
      { heading: "Minage", body: "Le minage SPEAQ est la Preuve de Contribution. Vous gagnez des Q-Credits en aidant le reseau. Votre telephone peut relayer des messages et valider des transactions. Vous gagnez 2-5 QC par jour." },
  ...
  es: {
    ...
    sections: [
      ...
      { heading: "Q-Credits y Cartera", body: "Los Q-Credits son la moneda interna de SPEAQ. 1 QC = 0.01 gram gold. Las transacciones son instantaneas y gratuitas. Tu saldo se almacena localmente." },
      { heading: "Mineria", body: "La mineria SPEAQ es Prueba de Contribucion. Ganas Q-Credits ayudando a la red. Tu telefono puede retransmitir mensajes y validar transacciones. Ganas 2-5 QC por dia." },
  ...
  ru: {
    ...
    sections: [
      ...
      { heading: "Q-Credits i Koshelek", body: "Q-Credits - vnutrennyaya valyuta SPEAQ. 1 QC = 0.01 gram gold. Tranzaktsii mgnovennyye i besplatnyye. Balans khranitsya lokalno." },
      { heading: "Mayning", body: "Mayning SPEAQ - Dokazatelstvo Vklada. Vy zarabatyvayete Q-Credits pomogaya seti. Vash telefon mozhet retranslirovat soobshcheniya i validirovat tranzaktsii. 2-5 QC v den." },
  ...
  de: {
    ...
    sections: [
      { heading: "Was ist SPEAQ?", body: "SPEAQ ist die sicherste Kommunikations- und Freiheitsplattform der Welt. Sie kombiniert quantenresistente Verschlusselung, Zensurresistenz, private Zahlungen und dezentrales Mining. Keine Regierung, kein Unternehmen und kein Hacker kann Ihre Nachrichten lesen." },
      ...
      { heading: "Q-Credits und Geldborse", body: "Q-Credits sind SPEAQs interne Wahrung. 1 QC = 0.01 gram gold. Transaktionen sind sofort und kostenlos. Ihr Guthaben wird lokal gespeichert." },
      { heading: "Mining", body: "SPEAQ Mining ist Beweis der Mitwirkung. Sie verdienen Q-Credits indem Sie dem Netzwerk helfen. Ihr Telefon kann Nachrichten weiterleiten und Transaktionen validieren. 2-5 QC pro Tag." },
  ...
  sl: {
    ...
    sections: [
      ...
      { heading: "Q-Credits in Denarnica", body: "Q-Credits so notranja valuta SPEAQ. 1 QC = 0.01 gram gold. Transakcije so takojsnje in brezplacne. Stanje je shranjeno lokalno." },
      { heading: "Rudarjenje", body: "SPEAQ Rudarjenje je Dokaz Prispevka. Zasluzite Q-Credits s pomocjo omrezju. Vas telefon lahko posreduje sporocila in potrjuje transakcije. 2-5 QC na dan." },
  ...
  lg: {
    ...
    sections: [
      { heading: "SPEAQ Kye Ki?", body: "SPEAQ ye pulaatifomu y'empuliziganya n'eddembe esinga kuyiikika mu nsi yonna. Ekwatiriza enkuuma ey'obukiiko, okuziyiza censorship, okusasula mu kyama ne mining. Tewali gavumenti oba hacker asobola kusoma bubaka bwo." },
      ...
      { heading: "Q-Credits n'Ensawo", body: "Q-Credits ze ssente za SPEAQ. 1 QC = 0.01 gram gold. Entambuza za mangu era za bwereere. Ensawo yo etereddwa ku simu yo." },
      { heading: "Mining", body: "SPEAQ Mining ye Obujulizi bw'Okuyamba. Ofuna Q-Credits ng'oyamba network. Simu yo esobola okuwereza bubaka n'okukakasa entambuza. 2-5 QC olunaku." },
  ...
  sw: {
    ...
    sections: [
      ...
      { heading: "Q-Credits na Mkoba", body: "Q-Credits ni sarafu ya ndani ya SPEAQ. 1 QC = 0.01 gram gold. Shughuli ni za papo hapo na bila malipo. Salio linahifadhiwa ndani ya kifaa." },
