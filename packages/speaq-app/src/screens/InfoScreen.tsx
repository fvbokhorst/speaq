...
const INFO: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  ...
  de: {
    ...
    sections: [
      ...
      { heading: "Mining", body: "SPEAQ Mining ist Beweis der Mitwirkung. Sie verdienen Q-Credits indem Sie dem Netzwerk helfen. Ihr Telefon kann Nachrichten weiterleiten und Transaktionen validieren. 0.02-0.05 QC pro Tag." },
  ...
  lg: {
    ...
    sections: [
      ...
      { heading: "Mining", body: "SPEAQ Mining ye Obujulizi bw'Okuyamba. Ofuna Q-Credits ng'oyamba network. Simu yo esobola okuwereza bubaka n'okukakasa entambuza. 0.02-0.05 QC olunaku." },
