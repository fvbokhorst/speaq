...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  cancelBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, borderWidth: 1.5, borderColor: c.signal.steel, backgroundColor: c.depth.elevated, alignItems: "center" },
  cancelText: { color: c.signal.white, fontSize: 14, fontWeight: "600" },
