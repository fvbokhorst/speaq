...
const INFO: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  en: {
    ...
    sections: [
      { heading: "What is SPEAQ?", body: "SPEAQ is a communication and freedom platform that lets you chat, call, send money, and earn rewards. It uses verified encryption (NIST-certified) to keep your messages private and your data under your control." },
      { heading: "Why is SPEAQ so secure?", body: "Every message, call, file, and payment is encrypted with AES-256 . The same standard used by banks worldwide. Each conversation has its own unique encryption key derived from SHA-256. The relay server sees ONLY encrypted data. It cannot read content, identify who is talking to whom, or determine what is being sent. This is called zero-knowledge architecture." },
      ...
      { heading: "Earning", body: "SPEAQ Earning is Proof of Contribution. You earn Q-Credits by helping the network grow. Your phone can relay messages (0.0001 QC each), validate transactions (0.0002 QC each), store encrypted fragments (0.0001 QC each), and more. You earn 0.02-0.05 QC per day (0.02-0.05 gram gold). In many countries this is significant income.\n\nHow halving works: every 2,100,000 QC earned by the network, rewards are cut in half. This creates scarcity and protects value. Early contributors earn more. The system supports approximately 960 contributors initially, decreasing with each halving. Total earning timeline: 40+ years before all 21 million QC are earned.\n\n7 ways to contribute:\n1. Relay Contribution: relay encrypted messages\n2. Mesh Contribution: act as Bluetooth/WiFi node\n3. Bridge Contribution: be a cash-to-QC agent\n4. Validation Contribution: validate transaction proofs\n5. Storage Contribution: store encrypted data\n6. Translation Contribution: translate the app\n7. Onboarding Contribution: bring new active users" },
      { heading: "Private Storage", body: "The Private Storage stores your sensitive files (photos, documents, notes) with encryption. It has two layers: a visible layer (normal PIN) and a hidden layer (secret PIN). If someone forces you to open your phone, the hidden layer is completely invisible. There is no technical proof it exists. This is called extra privacy layer." },
      { heading: "Private Groups", body: "Private Groups are invisible group chats. Members cannot see who else is in the group. The server has no record of the group. Messages are sent individually to each member. This protects activists, journalists, and anyone who needs to communicate without a visible group structure." },
  ...
  nl: {
    ...
    sections: [
      { heading: "Wat is SPEAQ?", body: "SPEAQ is een communicatie- en vrijheidsplatform waarmee je kunt chatten, bellen, geld sturen en beloningen verdienen. Het gebruikt geverifieerde encryptie (NIST-gecertificeerd) om je berichten prive te houden en je data onder jouw controle." },
      { heading: "Waarom is SPEAQ zo veilig?", body: "Elk bericht, gesprek, bestand en elke betaling wordt versleuteld met AES-256 -dezelfde standaard die wereldwijd door banken wordt gebruikt. Elk gesprek heeft zijn eigen unieke encryptiesleutel afgeleid van SHA-256. De relay server ziet ALLEEN versleutelde data -het kan geen inhoud lezen, niet identificeren wie met wie praat, of bepalen wat er wordt verzonden." },
      ...
      { heading: "Earning", body: "SPEAQ Earning is Bewijs van Bijdrage. Je verdient Q-Credits door het netwerk te helpen. Je telefoon kan berichten doorsturen (0,0001 QC), transacties valideren (0,0002 QC), en versleutelde fragmenten opslaan (0,0001 QC). Je verdient 0.02-0.05 QC per dag (0,02-0,05 gram goud).\n\nHoe halving werkt: elke 2.100.000 QC verdiend door het netwerk worden beloningen gehalveerd. Dit creert schaarste en beschermt de waarde. Vroege bijdragers verdienen meer. Het systeem ondersteunt initieel circa 960 contributors, afnemend bij elke halving. Totale earning tijdlijn: 40+ jaar.\n\n7 manieren om bij te dragen:\n1. Relay Contribution: berichten doorsturen\n2. Mesh Contribution: Bluetooth/WiFi node\n3. Bridge Contribution: cash-naar-QC agent\n4. Validatie Bijdrage: transactiebewijzen valideren\n5. Opslag Bijdrage: versleutelde data opslaan\n6. Vertaal Bijdrage: app vertalen\n7. Onboarding Contribution: nieuwe gebruikers aanbrengen" },
      { heading: "Prive Opslag", body: "De Prive Opslag slaat je gevoelige bestanden (foto's, documenten, notities) versleuteld op. Het heeft twee lagen: een zichtbare laag (normale PIN) en een verborgen laag (geheime PIN). Als iemand je dwingt je telefoon te openen, is de verborgen laag compleet onzichtbaar. Er is geen technisch bewijs dat het bestaat. Dit heet extra privacy layer." },
      { heading: "Prive Groepen", body: "Prive Groepen zijn onzichtbare groepschats. Leden kunnen niet zien wie er nog meer in de groep zit. De server heeft geen registratie van de groep. Berichten worden individueel naar elk lid gestuurd. Dit beschermt activisten, journalisten en iedereen die moet communiceren zonder een zichtbare groepsstructuur." },
  ...
  fr: {
    ...
    sections: [
      { heading: "Qu'est-ce que SPEAQ?", body: "SPEAQ est une plateforme de communication et de liberte qui vous permet de discuter, appeler, envoyer de l'argent et gagner des recompenses. Elle utilise un chiffrement verifie (certifie NIST) pour garder vos messages prives et vos donnees sous votre controle." },
      ...
      { heading: "Minage", body: "Le minage SPEAQ est la Preuve de Contribution. Vous gagnez des Q-Credits en aidant le reseau. Votre telephone peut relayer des messages et valider des transactions. Vous gagnez 0.02-0.05 QC par jour." },
      { heading: "Stockage Prive", body: "Le Stockage Prive stocke vos fichiers sensibles avec chiffrement. Il a deux couches: visible (PIN normal) et cachee (PIN secret). La couche cachee est completement invisible. C'est le couche de confidentialite." },
      { heading: "Groupes Prives", body: "Les Groupes Prives sont des discussions de groupe avec acces sur invitation uniquement. Les membres ne peuvent pas voir qui d'autre est dans le groupe. Cela protege les activistes et journalistes." },
  ...
  es: {
    ...
    sections: [
      { heading: "Que es SPEAQ?", body: "SPEAQ es una plataforma de comunicacion y libertad que te permite chatear, llamar, enviar dinero y ganar recompensas. Utiliza cifrado verificado (certificado NIST) para mantener tus mensajes privados y tus datos bajo tu control." },
      ...
      { heading: "Mineria", body: "La mineria SPEAQ es Prueba de Contribucion. Ganas Q-Credits ayudando a la red. Tu telefono puede retransmitir mensajes y validar transacciones. Ganas 0.02-0.05 QC por dia." },
      { heading: "Almacenamiento Privado", body: "La Almacenamiento Privado almacena tus archivos sensibles con cifrado. Tiene dos capas: visible (PIN normal) y oculta (PIN secreto). La capa oculta es completamente invisible. Capa de privacidad." },
  ...
  ru: {
    ...
    sections: [
      { heading: "Chto takoe SPEAQ?", body: "SPEAQ - samaya bezopasnaya platforma svyazi i svobody v mire. Ona ob'edinyaet kvantovo-ustojchivoe shifrovanie, ustoychivost k tsenzure, chastnye platezhi i detsentralizovannyy mayning. Ni odno pravitelstvo ili khaker ne mozhet chitat vashi soobshcheniya." },
      ...
      { heading: "Mayning", body: "Mayning SPEAQ - Dokazatelstvo Vklada. Vy zarabatyvayete Q-Credits pomogaya seti. Vash telefon mozhet retranslirovat soobshcheniya i validirovat tranzaktsii. 0.02-0.05 QC v den." },
  ...
  de: {
    ...
    sections: [
      { heading: "Was ist SPEAQ?", body: "SPEAQ ist eine Kommunikations- und Freiheitsplattform, mit der Sie chatten, telefonieren, Geld senden und Belohnungen verdienen konnen. Sie verwendet verifizierte Verschlusselung (NIST-zertifiziert), um Ihre Nachrichten privat und Ihre Daten unter Ihrer Kontrolle zu halten." },
      ...
      { heading: "Earning", body: "SPEAQ Earning ist Beweis der Mitwirkung. Sie verdienen Q-Credits indem Sie dem Netzwerk helfen. Ihr Telefon kann Nachrichten weiterleiten und Transaktionen validieren. 0.02-0.05 QC pro Tag." },
  ...
  sl: {
    ...
    sections: [
      { heading: "Kaj je SPEAQ?", body: "SPEAQ je komunikacijska in svobodna platforma, ki vam omogoca klepetanje, klicanje, posiljanje denarja in zasluzek nagrad. Uporablja preverjeno sifriranje (NIST-certificirano) za zasebnost vasih sporocil in nadzor nad vasimi podatki." },
      ...
      { heading: "Rudarjenje", body: "SPEAQ Rudarjenje je Dokaz Prispevka. Zasluzite Q-Credits s pomocjo omrezju. Vas telefon lahko posreduje sporocila in potrjuje transakcije. 0.02-0.05 QC na dan." },
  ...
  lg: {
    ...
    sections: [
      { heading: "SPEAQ Kye Ki?", body: "SPEAQ ye pulaatifomu y'empuliziganya n'eddembe ekukkiriza okuwuliziganya, okukuba, okutuma ssente, n'okufuna empeera. Ekozesa enkuuma eyakakasibwa (NIST) okukuuma bubaka bwo mu kyama." },
      ...
      { heading: "Earning", body: "SPEAQ Earning ye Obujulizi bw'Okuyamba. Ofuna Q-Credits ng'oyamba network. Simu yo esobola okuwereza bubaka n'okukakasa entambuza. 0.02-0.05 QC olunaku." },
      { heading: "Okutereka Ekyama", body: "Okutereka ekyama kutereka fayiro zo enkuumiddwa. Ebifo bibiri: ekirabikirwa (PIN ow'enjawulo) n'ekikisiddwa (PIN ow'ekyama). Ekifo ekikisiddwa tekirabikirwa." },
  ...
  sw: {
    ...
    sections: [
      { heading: "SPEAQ ni Nini?", body: "SPEAQ ni jukwaa la mawasiliano na uhuru linalokuwezesha kupiga gumzo, kupiga simu, kutuma pesa, na kupata zawadi. Inatumia usimbaji uliothaminishwa (NIST) kuweka ujumbe wako faragha na data yako chini ya udhibiti wako." },
      ...
      { heading: "Uchimbaji", body: "Uchimbaji wa SPEAQ ni Uthibitisho wa Mchango. Unapata Q-Credits kwa kusaidia mtandao. Simu yako inaweza kupitisha ujumbe na kuthibitisha shughuli. QC 2-5 kwa siku." },
      { heading: "Hifadhi ya Faragha", body: "Hifadhi ya Faragha huhifadhi faili nyeti kwa usimbaji. Tabaka mbili: inayoonekana (PIN ya kawaida) na iliyofichwa (PIN ya siri). Tabaka iliyofichwa haionekani kabisa." },
